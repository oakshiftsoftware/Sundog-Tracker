...
class DataService:
    ...
    def __init__(self, app):
        self.app = app
        # Safely resolve config; fall back to defaults if missing
        # Prefer custom app_config if present; fall back to app.config
        ...
        # Ensure paths exist even if app.config is None
        resources_path = (
        ...
        # Map keys to URLs and cache filenames
        self.sources = {
            "blueprints": {
                "url": blueprints_path,
